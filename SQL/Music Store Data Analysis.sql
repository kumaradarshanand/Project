...
SELECT billing_country, COUNT (billing_country) AS billing_count
FROM invoice
...
SELECT DISTINCT customer.first_name, customer.last_name, customer.email, genre.name AS genre_name
FROM customer
